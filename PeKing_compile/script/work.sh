...
if [ -f /z/Tradeupdate/${Des_name}.zip ];then
    rm -f /z/Tradeupdate/${Des_name}.zip
    check_work "删除NAS存储下${Des_name}.zip"
fi

cp ${Work_new}/${Des_name}.zip /z/Tradeupdate/
check_work "本次编译生成增量文件压缩包移动到生产环境目录/z/Tradeupdate/下"
